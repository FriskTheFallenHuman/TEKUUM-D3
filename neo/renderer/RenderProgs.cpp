...
void idRenderProgManager::Init()
{
	...
	} builtins[] =
	{
		...
		{ BUILTIN_TEXTURE_YCOCG, "builtin/texture_ycocg", "",  0, false, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT },
...
#else
		{ BUILTIN_ROQ, "builtin/video/roq", "",  0, false, SHADER_STAGE_DEFAULT, LAYOUT_DRAW_VERT },
#endif
	...
	for( int i = 0; i < numBuiltins; i++ )
	{
		...
		uint32_t shaderFeatures = builtins[i].shaderFeatures;
...
================================================================================================
*/
int idRenderProgManager::FindShader( const char* name, rpStage_t stage, const char* nameOutSuffix, uint32_t features, bool builtin, vertexLayoutType_t vertexLayout )
{
