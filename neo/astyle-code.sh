...
$ASTYLE_BIN -v --formatted --options=astyle-options.ini --exclude="libs" --exclude="base/gamesys/SysCvar.cpp" --exclude="base/gamesys/Callbacks.cpp" --exclude="d3xp/gamesys/SysCvar.cpp" --exclude="d3xp/gamesys/Callbacks.cpp" \
